...
export const DEFAULT_METADATA_TITLE = 'Infinity Vape Store';
...
export const DEV_API = ENV_VARIABLES.VITE_VENDURE_DEV_URL || 'https://dashboard.infinityvape.store';
export const PROD_API = ENV_VARIABLES.VITE_VENDURE_PROD_URL || 'https://dashboard.infinityvape.store';
